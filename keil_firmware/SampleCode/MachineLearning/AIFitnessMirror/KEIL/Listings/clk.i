...
# 1208 "../../../../Library/StdDriver/src/clk.c"
...
# 1439 "../../../../Library/StdDriver/src/clk.c"
...
# 1466 "../../../../Library/StdDriver/src/clk.c"
uint32_t CLK_WaitClockReady(uint32_t u32ClkMask)
{
...
# 1498 "../../../../Library/StdDriver/src/clk.c"
uint32_t CLK_WaitClockDisable(uint32_t u32ClkMask)
{
    uint32_t u32TimeOutCnt = SystemCoreClock >> 1;
...
# 1529 "../../../../Library/StdDriver/src/clk.c"
void CLK_EnableSysTick(uint32_t u32ClkSrc, uint32_t u32Count)
{
...
uint32_t CLK_GetAPLL0ClockFreq(void)
{
    ...
    else
    {
        ...
        else if ((u32PllReg1 & (0x3ul << (0))) == 0x00000001UL)
        {
            u32FIN = (24000000UL) / 2;
        }
        else
...
# 1801 "../../../../Library/StdDriver/src/clk.c"
uint32_t CLK_GetModuleClockSource(uint64_t u64ModuleIdx)
{
    uint32_t u32TmpVal = 0UL, u32TmpAddr = 0UL;
...
# 1848 "../../../../Library/StdDriver/src/clk.c"
uint32_t CLK_GetModuleClockDivider(uint64_t u64ModuleIdx)
{
...
# 1888 "../../../../Library/StdDriver/src/clk.c"
uint32_t CLK_SetBusClock(uint32_t u32SCLKSrc, uint32_t u32PllClkSrc, uint32_t u32PllFreq)
{
...
# 1961 "../../../../Library/StdDriver/src/clk.c"
void CLK_SysTickDelay(uint32_t us)
{
...
# 2039 "../../../../Library/StdDriver/src/clk.c"
void CLK_SysTickLongDelay(uint32_t us)
{
    uint32_t u32Delay;
