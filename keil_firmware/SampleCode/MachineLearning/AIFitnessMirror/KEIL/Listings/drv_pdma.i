...
# 19 "C:\\Users\\fanju\\AppData\\Local\\Keil_v5\\ARM\\ARMCLANG\\bin\\..\\include\\inttypes.h" 3
...
# 20 "C:\\Users\\fanju\\AppData\\Local\\Keil_v5\\ARM\\ARMCLANG\\bin\\..\\include\\inttypes.h" 2 3
...
static int nu_pdma_timeout_set(int i32ChannID, int i32Timeout_us)
{
    ...
    if (i32Timeout_us)
    {
        ...
        PDMA_EnableInt(PDMA, u32ModChannId, 0x00000002UL);
    ...
    {
        PDMA_DisableInt(PDMA, u32ModChannId, 0x00000002UL);
        PDMA_DisableTimeout(PDMA, 1 << u32ModChannId);
    }
...
static void _nu_pdma_transfer(int i32ChannID, uint32_t u32Peripheral, nu_pdma_desc_t head, uint32_t u32IdleTimeout_us)
{
    ...
    PDMA_EnableInt(PDMA, ((i32ChannID)%16UL), 0x00000000UL);
