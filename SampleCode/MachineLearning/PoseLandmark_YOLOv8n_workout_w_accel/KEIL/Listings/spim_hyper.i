...
{
    volatile int32_t i32TimeOutCnt = (SystemCoreClock >> 1);
    ...
    u32MLDOPL0 = ((((((*((volatile unsigned int *)(((((uint32_t) 0x40000000UL) + 0x00000000UL) + 0x00000UL) + 0xF54))))) & (0x3Ful << (0))) >> (0)) + (3U));
    do{ uint32_t u32Value = ((((*((volatile unsigned int *)(((((uint32_t) 0x40000000UL) + 0x00000000UL) + 0x00000UL) + 0xF54))))) & ~(0x3Ful << (0))) | ((u32MLDOPL0) << (0)); (*((volatile unsigned int *)((((((uint32_t) 0x40000000UL) + 0x00000000UL) + 0x00000UL) + 0xF54)))=(u32Value)); }while(0);
    ...
    while ((((((*((volatile unsigned int *)(((((uint32_t) 0x40000000UL) + 0x00000000UL) + 0x00000UL) + 0xF54))))) & (0x1ul << (31))) >> (31)) == (0x01UL))
        if (i32TimeOutCnt-- <= 0) break;

    i32TimeOutCnt = (SystemCoreClock >> 1);


    while (*(volatile uint32_t *)(((((uint32_t) 0x40000000UL) + 0x00000000UL) + 0x02000UL)+0x010UL) & (0x80000000UL))
        if (i32TimeOutCnt-- <= 0) break;
    ...
    u32MLDOPL0 = ((((((*((volatile unsigned int *)(((((uint32_t) 0x40000000UL) + 0x00000000UL) + 0x00000UL) + 0xF80))))) & (0xFul << (0))) >> (0)) + (5U));
    do { uint32_t u32Value = ((((*((volatile unsigned int *)(((((uint32_t) 0x40000000UL) + 0x00000000UL) + 0x00000UL) + 0xF80))))) & ~(0xFul << (0))) | ((u32MLDOPL0) << (0)); (*((volatile unsigned int *)((((((uint32_t) 0x40000000UL) + 0x00000000UL) + 0x00000UL) + 0xF80)))=(u32Value)); } while (0);
...
# 196 "../../../../Library/StdDriver/src/spim_hyper.c"
void SPIM_HYPER_Init(SPIM_T *spim, uint32_t u32HyperMode, uint32_t u32Div)
{
...
# 217 "../../../../Library/StdDriver/src/spim_hyper.c"
...
# 245 "../../../../Library/StdDriver/src/spim_hyper.c"
int32_t SPIM_HYPER_Reset(SPIM_T *spim)
{
...
# 267 "../../../../Library/StdDriver/src/spim_hyper.c"
int32_t SPIM_HYPER_ExitHSAndDPD(SPIM_T *spim)
{
...
# 287 "../../../../Library/StdDriver/src/spim_hyper.c"
int32_t SPIM_HYPER_ReadHyperRAMReg(SPIM_T *spim, uint32_t u32Addr)
{
...
# 320 "../../../../Library/StdDriver/src/spim_hyper.c"
int32_t SPIM_HYPER_WriteHyperRAMReg(SPIM_T *spim, uint32_t u32Addr, uint32_t u32Value)
{
    if ((u32Addr != (0x00000000)) &&
            (u32Addr != (0x00000002)) &
...
# 349 "../../../../Library/StdDriver/src/spim_hyper.c"
int16_t SPIM_HYPER_Read1Word(SPIM_T *spim, uint32_t u32Addr)
{
    spim->HYPER_ADR = u32Addr;
...
# 386 "../../../../Library/StdDriver/src/spim_hyper.c"
int32_t SPIM_HYPER_Write1Byte(SPIM_T *spim, uint32_t u32Addr, uint8_t u8Data)
{
    (spim->HYPER_WDATA &= ~(0xFFFFFFFF));
...
# 407 "../../../../Library/StdDriver/src/spim_hyper.c"
int32_t SPIM_HYPER_Write2Byte(SPIM_T *spim, uint32_t u32Addr, uint16_t u16Data)
{
    (spim->HYPER_WDATA &= ~(0xFFFFFFFF));
...
# 428 "../../../../Library/StdDriver/src/spim_hyper.c"
int32_t SPIM_HYPER_Write3Byte(SPIM_T *spim, uint32_t u32Addr, uint32_t u32Data)
{
    (spim->HYPER_WDATA &= ~(0xFFFFFFFF));
...
# 449 "../../../../Library/StdDriver/src/spim_hyper.c"
int32_t SPIM_HYPER_Write4Byte(SPIM_T *spim, uint32_t u32Addr, uint32_t u32Data)
{
    (spim->HYPER_WDATA &= ~(0xFFFFFFFF));
...
# 472 "../../../../Library/StdDriver/src/spim_hyper.c"
int32_t SPIM_HYPER_DMAWrite(SPIM_T *spim, uint32_t u32Addr, uint8_t *pu8WrBuf, uint32_t u32NTx)
{
...
# 494 "../../../../Library/StdDriver/src/spim_hyper.c"
int32_t SPIM_HYPER_DMARead(SPIM_T *spim, uint32_t u32Addr, uint8_t *pu8RdBuf, uint32_t u32NRx)
{
...
# 534 "../../../../Library/StdDriver/src/spim_hyper.c"
int32_t SPIM_HYPER_INIT_DLL(SPIM_T *spim)
{
    ...
    uint32_t u32DelayCycleCount = (u32BusClkHz / 1000) * 3;
...
# 636 "../../../../Library/StdDriver/src/spim_hyper.c"
int32_t SPIM_HYPER_SetDLLDelayNum(SPIM_T *spim, uint32_t u32DelayNum)
{
    volatile int i32TimeoutCount = SystemCoreClock;
